...
const EditProduct: FunctionComponent<EditProductProps> = () => {
    ...
    return (<>
        <form className="mb-3" onSubmit={formik.handleSubmit}>
            <h3 className="display-3">Edit Product</h3>
            ...
            <button type="submit" className="btn btn-success mt-3" disabled={!formik.isValid || !formik.dirty}>update</button>
        </form>
    </>);
}
